...
public class PostRequest extends ApiTestBase {
    ...
    /**
     * Sends a post request with the specified endpoint and a payload object
     *
    ...
    /**
     * Sends a post request with the specified endpoint
     *
